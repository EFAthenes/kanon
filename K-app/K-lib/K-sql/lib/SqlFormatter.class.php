...
class SqlFormatter
{
    ...
    const int TOKEN_TYPE_WHITESPACE = 0;
    const int  TOKEN_TYPE_WORD = 1;
    const int  TOKEN_TYPE_QUOTE = 2;
    const int  TOKEN_TYPE_BACKTICK_QUOTE = 3;
    const int  TOKEN_TYPE_RESERVED = 4;
    const int  TOKEN_TYPE_RESERVED_TOPLEVEL = 5;
    const int  TOKEN_TYPE_RESERVED_NEWLINE = 6;
    const int  TOKEN_TYPE_BOUNDARY = 7;
    const int  TOKEN_TYPE_COMMENT = 8;
    const int  TOKEN_TYPE_BLOCK_COMMENT = 9;
    const int  TOKEN_TYPE_NUMBER = 10;
    const int  TOKEN_TYPE_ERROR = 11;
    const int  TOKEN_TYPE_VARIABLE = 12;

    // Constants for different components of a token
    const int  TOKEN_TYPE = 0;
    const int  TOKEN_VALUE = 1;
    ...
    /**
     * 
     * @var array<int,string> $reserved_toplevel
     */    
    ...
    /**
     * 
     * @var array<int,string> $reserved_newline
     */
    ...
    /**
     * 
     * @var array<int,string> $boundaries
     */
    ...
    protected static string $regex_boundaries;
    protected static string $regex_reserved;
    protected static string $regex_reserved_newline;
    protected static string $regex_reserved_toplevel;
    protected static string $regex_function;

    // Cache variables
    // Only tokens shorter than this size will be cached.  Somewhere between 10 and 20 seems to work well for most cases.
    public static int $max_cachekey_size = 15;
    /**
     * @var array<mixed,mixed> $token_cache
     */
    protected static array $token_cache = array();
    protected static int $cache_hits = 0;
    protected static int $cache_misses = 0;

    /**
     * Get stats about the token cache
     * @return array<string,string|int> An array containing the keys 'hits', 'misses', 'entries', and 'size' in bytes
     */
     ...
     * @param array<mixed,mixed>|null  $previous The result of the previous getNextToken() call
     *
     * @return array<int,int|string> An associative array containing the type and value of the token.
     */
    protected static function getNextToken(string $string,?array $previous = null)
    {
        // Whitespace
     ...
     * @return string|null
     */
    protected static function getQuotedString(string $string) : ?string
    {
        $ret = null;
     ...
     * @param string $string The SQL string
     *
     * @return array<int,array<int|string,int|string>> An array of tokens.
     */
    protected static function tokenize($string) : array
    {
        self::init();
     ...
     * @param string $string The SQL string
     *
     * @return array<int,string> An array of individual query strings without trailing semicolons
     */
    public static function splitQuery(string $string)
    {
        $queries = array();
        $current_query = '';
        $empty = true;
     ...
     *
     * @param array<int|string,int|string> $token An associative array containing type and value.
     *
