...
class KRemoteAddress
{
    ...
    {
        $proxy=ParamManager::getInstance()->trusted_proxy;
        $this->setTrustedProxies([$proxy]);
     ...
     * @return KRemoteAddress
     */
    public function setUseProxy($useProxy = true) : self
    {
     ...
     * @return KRemoteAddress
     */
    public function setProxyHeader($header = 'X-Forwarded-For') : self
    {
     ...
     * @return false|string
     */
    public function getIpAddressFromProxy() : false|string
    {
        if (! $this->useProxy
